...
{
    public class EFCoreCollaboratorRepository :
        EfCoreRepository<IncubationCentreDbContext, Collaborator, Guid>,
        ICollaboratorRepository
    {
        public EFCoreCollaboratorRepository(IDbContextProvider<IncubationCentreDbContext> dbContextProvider) 
        ...
        public async Task<List<Collaborator>> GetListAsync(string filter = null, string userName = null, string name = null, string surname = null, string email = null, string phoneNumber = null, string experience = null, Guid[] SkillIds = null, string about = null, bool filterByActiveted = false, bool isActivated = true, int skipCount = 0, int maxResultCount = int.MaxValue, string sorting = null, CancellationToken cancelationToken = default)
        {
            var query = ApplyFilter(
        ...
        protected virtual IQueryable<Collaborator> ApplyFilter(
           IQueryable<Collaborator> query,
            string filter,
        ...
        public async Task<Collaborator> GetWithDetailAsync(Guid id, CancellationToken cancellationToken = default)
        {
            var dbSet = (await GetDbSetAsync())
                .Include(c => c.Skills)
                .Include(c => c.CollaboratoringProjects).ThenInclude(b => b.Milestones)
