...
{
    public class EFCoreSystemManagerRepository :
        EfCoreRepository<IncubationCentreDbContext, SystemManager, Guid>,
        ISystemManagerRepository
    {
        public EFCoreSystemManagerRepository(IDbContextProvider<IncubationCentreDbContext> dbContextProvider) 
        ...
        protected virtual IQueryable<SystemManager> ApplyFilter(
           IQueryable<SystemManager> query,
            string filter,
        ...
        public async Task<SystemManager> GetWithDetailAsync(Guid id, CancellationToken cancellationToken = default)
        {
